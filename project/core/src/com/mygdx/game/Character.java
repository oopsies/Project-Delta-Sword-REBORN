...
public class Character implements CharacterStates { //parent character class
    ...
    public Character(GameData.Player p){
        ...
        indicator = (p == GameData.Player.PLAYER1) ? new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\indicator1.png")) : new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\indicator2.png"));
