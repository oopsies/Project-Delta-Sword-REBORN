...
public final class GameData { //this class has other static classes that are purely for storing data and nothing else. no objects of this class should be created.
    ...
    public static class CharacterData{
        ...
        public static Sprite getSprite(Character characterType){
            if (characterType instanceof Knight)
                return new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_knight_idle.png"));
            else if (characterType instanceof Assassin)
                return new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_assassin_idle.png"));
            else if (characterType instanceof Mage)
                return new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_mage_idle.png"));
            else
                return new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_parent.png"));
        }
