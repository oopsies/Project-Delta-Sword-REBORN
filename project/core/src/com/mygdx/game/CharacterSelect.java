...
public class CharacterSelect {
    ...
    public CharacterSelect(){
        ...
        knight = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_knight_idle.png"));
        knight.setSize(5f, 5f * Window.yConst);
        assassin = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_assassin_idle.png"));
        assassin.setSize(5f, 5f * Window.yConst);
        mage = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\spr_mage_idle.png"));
        mage.setSize(5f, 5f * Window.yConst);

        knightInfo = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\knightInfo.png"));
        knightInfo.setSize(30f, 50f * Window.yConst);
        assassinInfo = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\assassinInfo.png"));
        assassinInfo.setSize(30f, 50f * Window.yConst);
        mageInfo = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\mageInfo.png"));
        ...
        p1Ind = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\indicator1.png"));
        p1Ind.setSize(3f, 3f * Window.yConst);
        p2Ind = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\indicator2.png"));
        p2Ind.setSize(3f, 3f * Window.yConst);

        presse = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\presse.png"));
        presse.setSize(50f, 5f);

        select = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\selectachar.png"));
        select.setSize(30f, 5f);
        infoPress = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\specialinfo.png"));
