...
public class Score {
    ...
    public Score(int stocks){
        ...
        p1Stock = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\p1stock.png"));
        p1Stock.setSize(50f, 50f);
        p2Stock = new Sprite(new Texture("C:\\Users\\Ryan\\Downloads\\test\\core\\assets\\image\\p2stock.png"));
